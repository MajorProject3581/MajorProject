  ...
  return (
    ...
    <div className="c-wrap">
      ...
      <div className="c-container">
        <img src={Leath} alt="Instrumental" className="c-image" />
        <div className="c-info">
          <h2>What is Leather Technology?</h2>
          <p>
          ...
          <h2>What does an Leather Engineer do?</h2>
          ...
          <h2>Job Opportunities for Leather Engineers</h2>
          <p>
            {" "}
          ...
          <h2>Popular Companies that hire Leather Engineers</h2>
          <p>
            <ul>
