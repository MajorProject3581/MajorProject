  ...
  return (
    ...
    <div className="c-wrap">
      ...
      <div className="c-container">
        <img src={Electronics} alt="Instrumental" className="c-image" />
        <div className="c-info">
          <h2>What is Electronics Engineering?</h2>
          <p>
          ...
          <h2>What does an Electronics Engineer do?</h2>
          ...
          <h2>Job Opportunities for Electronics Engineers</h2>
          <p>
            {" "}
          ...
          <h2>Popular Companies that hire Electronics Engineers</h2>
          <p>
            <ul>
              <li>Synopsis</li>
              <li>Kingston</li>
