  ...
  return (
    ...
    <div className="c-wrap">
      ...
      <div className="c-container">
        <img src={Electric} alt="Electrical" className="c-image" />
        <div className="c-info">
          ...
          <h2>What does an Electrical Engineer do?</h2>
          ...
          <h2>Job Opportunities for Electrical Engineers</h2>
          <p>
            {" "}
          ...
          <h2>Popular Companies that hire Electrical Engineers</h2>
          <p>
            <ul>
              <li>TATA power</li>
