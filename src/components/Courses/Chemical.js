  ...
  return (
    ...
    <div className="c-wrap">
      ...
      <div className="c-container">
        <img src={Chem} alt="Chemical" className="c-image" />
        <div className="c-info">
          ...
          <h2>What does an Chemical Engineer do?</h2>
          ...
          <h2>Job Opportunities for Chemical Engineers</h2>
          <p>
            {" "}
          ...
          <h2>Popular Companies that hire Chemical Engineers</h2>
          <p>
            <ul>
