      ...
      <div className="c">
        <div className="c-wrap">
          ...
          <div className="c-container">
            <img src={ITimg} alt="IT" className="c-image" />
            <div className="c-info">
              <br></br>
              <h2>What is IT engineering?</h2>
              <p>
              ...
              <h2>What does IT Engineer do?</h2>
              <p>
              ...
              <br></br>
              <h2>Job Opportunities for IT Engineers</h2>
              <p>
              ...
              <br></br>
              <h2>Popular Companies that hire IT Engineers</h2>
              <p>
                <ul>
