      ...
      <div className="c">
        <div className="c-wrap">
          ...
          <div className="c-container">
            <img src={Civil} alt="Civil" className="c-image" />
            <div className="c-info">
              ...
              <h2>What does civil Engineer do?</h2>
              <p>
              ...
              <br></br>
              <h2>Job Opportunities for civil Engineers</h2>
              <p>
              ...
              <br></br>
              <h2>Popular Companies that hire civil Engineers</h2>
              <p>
                <ul>
                  <li> Arup</li>
                  <li> Vinci</li>
