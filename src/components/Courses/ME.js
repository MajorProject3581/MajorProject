    ...
    return (
      ...
      <div className="c-wrap">
        ...
        <div className="c-container">
          <img src={Mechanical} alt="Mechanical" className="c-image" />
          <div className="c-info">
            ...
            <h2>What does Mechanical Engineer do?</h2>
            <p>
            ...
            <br></br>
            <h2>Job Opportunities for Mechanical Engineers</h2>
            <p>
            ...
            <br></br>
            <h2>Popular Companies that hire Mechanical Engineers</h2>
            <p>
              <ul>
