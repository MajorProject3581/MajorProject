          ...
          <div className="bg">
            <div className="lefth1">
              ...
              <div className='btnh'>
                ...
                <button className='sbtn2'>Find Courses</button>

              </div>
              <h3 className="h3"><b>Choose from over more than 350 colleges<br /> and more than 12 fields</b></h3>
            </div>
            <div className="right1">
              <img src="https://img.freepik.com/free-vector/college-university-students-group-young-happy-people-standing-isolated-white-background_575670-66.jpg?w=826&t=st=1664094586~exp=1664095186~hmac=b37b48ac97e482680e28d075778df06df1c994a1cca4ca19550264534aa07bf1" className='sl'></img>
            </div>
          </div>
        </div>
      ...
      <Carousel.Item >
        <div className="main-bg">
          <div className="bg">
            ...
            <div className="right1">
              <img src="https://img.freepik.com/free-vector/empowering-education_3446-308.jpg?w=740&t=st=1664097927~exp=1664098527~hmac=68f100185cabef965949356ad30ec3df0c0ffb20862be514c24d097bf94becff" className="sl"></img>
            </div>
          </div>
        </div>
      </Carousel.Item>
      <Carousel.Item >
        <div className="main-bg">
          <div className="bg">
            ...
            <div className="right1">
              <img src="https://img.freepik.com/free-vector/illustration-university-graduates_53876-28466.jpg?w=1060&t=st=1664089453~exp=1664090053~hmac=1c82d4032f21b9b3f79650dba247d0dd8a0540756c439c10ce5c82c6ad4aca12" className='sl1'></img>
            </div>
          </div>
        </div>
      </Carousel.Item>
