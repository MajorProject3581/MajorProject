...
function FilterA(props) {
    ...
    const getData = async () => {
        let response = await fetch("http://localhost:3001/colleges/");
        ...
        <>
            <div className="f">
                ...
                <div className="f-bottom">
                    ...
                    <RightFYC showMe={showMe} searchItem={searchItem} selectedFees={selectedFees} selectedCourse={selectedCourse} No={NO}
                     ecart={props.cart} esetCart={props.setCart}/>
